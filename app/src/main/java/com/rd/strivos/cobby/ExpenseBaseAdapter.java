...
public class ExpenseBaseAdapter extends BaseAdapter {
    ...
    public ExpenseBaseAdapter(Context context, ArrayList<ListDataExpense> myList) {
        this.myList = myList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((ExpenseListPage) context).startAddExpensesActivity(Long.valueOf(tEXT).longValue());
            }
        });
        ...
        convertView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                TextView text = (TextView) view.findViewById(R.id.txt_frameIdDisplay);
                String tEXT = text.getText().toString();
                ((ExpenseListPage) context).deleteExpense(Long.valueOf(tEXT).longValue());
                return true;
            }
        });
