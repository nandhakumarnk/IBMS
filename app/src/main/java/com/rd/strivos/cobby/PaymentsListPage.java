 ...
 */
public class PaymentsListPage extends AppCompatActivity{

    ListView lvDetail;
    Context context = PaymentsListPage.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getDataInList();
        lvDetail.setAdapter(new PaymentsBaseAdapter(context, myList));
    }
