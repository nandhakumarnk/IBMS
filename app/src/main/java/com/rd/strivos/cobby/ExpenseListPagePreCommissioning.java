 ...
 */
public class ExpenseListPagePreCommissioning extends AppCompatActivity {
    ListView lvDetail;
    Context context = ExpenseListPagePreCommissioning.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getDataInList();
        lvDetail.setAdapter(new PreCommissioningBaseAdapter(context, myList));
    }
