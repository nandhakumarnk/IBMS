 ...
 */
public class StatutoryDocumentsListPage extends AppCompatActivity{

    ListView lvDetail;
    Context context = StatutoryDocumentsListPage.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getDataInList();
        lvDetail.setAdapter(new StatutoryDocumentsBaseAdapter(context, myList));
    }
