 ...
 */
public class GrievanceListPageServiceVisit extends AppCompatActivity {
    ListView lvDetail;
    Context context = GrievanceListPageServiceVisit.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getDataInList();
        lvDetail.setAdapter(new GrievanceListPageServiceVisitBaseAdapter(context, myList));
    }
