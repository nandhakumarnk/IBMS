 ...
 */
public class SparesListPageServiceVisitBaseAdapter extends BaseAdapter{
    ...
    public SparesListPageServiceVisitBaseAdapter(Context context, ArrayList<ListDataSpares> myList) {
        this.myList = myList;
...
//                ((SparesListPageServiceVisit) context).startAddSparesActivity(Long.valueOf(tEXT).longValue());
//            }
//        });
//
...
//                TextView text = (TextView) view.findViewById(R.id.txt_frameIdDisplay);
//                String tEXT = text.getText().toString();
//                ((SparesListPageServiceVisit) context).deleteSpares(Long.valueOf(tEXT).longValue());
//                return true;
//            }
//        });
