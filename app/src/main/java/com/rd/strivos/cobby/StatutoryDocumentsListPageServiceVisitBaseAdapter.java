 ...
 */
public class StatutoryDocumentsListPageServiceVisitBaseAdapter extends BaseAdapter{
    ArrayList<ListDataStatutoryDocuments> myList = new ArrayList<ListDataStatutoryDocuments>();
    LayoutInflater inflater;
    Context context;
    int[] result;

    public StatutoryDocumentsListPageServiceVisitBaseAdapter(Context context, ArrayList<ListDataStatutoryDocuments> myList) {
        this.myList = myList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((StatutoryDocumentsListPageServiceVisit) context).startAddStatutoryDocumentsActivity(Long.valueOf(tEXT).longValue());
            }
        });
        ...
        convertView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                TextView text = (TextView) view.findViewById(R.id.txt_frameIdDisplay);
                String tEXT = text.getText().toString();
                ((StatutoryDocumentsListPageServiceVisit) context).deleteStatutoryDocuments(Long.valueOf(tEXT).longValue());
                return true;
            }
        });
