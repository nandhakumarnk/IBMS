 ...
 */
public class CommissioningExpenseListPage extends AppCompatActivity{
    ListView lvDetail;
    Context context = CommissioningExpenseListPage.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getDataInList();
        lvDetail.setAdapter(new CommissioningExpenseBaseAdapter(context, myList));
    }
