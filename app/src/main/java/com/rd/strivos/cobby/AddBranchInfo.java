...
public class AddBranchInfo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.addbranchinfo);
        etCity = (EditText) findViewById(R.id.edtCity_binfo);
        etAddress = (EditText) findViewById(R.id.edtAddress_binfo);
        etName = (EditText) findViewById(R.id.edtContanctPerson_binfo);
        etDesignation = (EditText) findViewById(R.id.edtDesignation_binfo);
        etPhone = (EditText) findViewById(R.id.edtPhone_binfo);
        etMobile = (EditText) findViewById(R.id.edtMobile_binfo);
        etEmail = (EditText) findViewById(R.id.edtemail_binfo);
        btnSave = (Button) findViewById(R.id.add_binfo);
        btnClear = (Button) findViewById(R.id.remove_binfo);
        lstView = (ListView) findViewById(R.id.lst_binfo);
                ...
                if (Name.length() != 0 & Designation.length() != 0
                    ...
                    if (isValidEmail(Email) != false) {
                        if (isValidMobile(Phone) != false) {
                            db.insertBranchInfo(ProjectID, City, address, Name, Designation,
                                    Phone, mobile, Email, ProjectType, Status);
                            refreshList();
                            clearAll();
                            Toast toast = Toast.makeText(AddBranchInfo.this,
                                    "Saved",
                                    Toast.LENGTH_SHORT);
                            toast.show();
                        } else {
