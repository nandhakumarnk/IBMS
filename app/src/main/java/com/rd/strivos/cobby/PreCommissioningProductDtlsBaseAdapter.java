 ...
 */
public class PreCommissioningProductDtlsBaseAdapter extends BaseAdapter {
    ...
    public PreCommissioningProductDtlsBaseAdapter(Context context, ArrayList<ListDataInstallProductDtls> myList) {
        this.myList = myList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((PreCommissioningProductDtls) context).startProductInstallActivity(Long.valueOf(tEXT).longValue());
            }
        });
//
