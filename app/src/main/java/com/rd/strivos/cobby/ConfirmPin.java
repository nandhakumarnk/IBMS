            ...
            public void onClick(View v) {
                ...
                if (userEntered.length() < PIN_LENGTH) {
                    ...
                    if (userEntered.length() == PIN_LENGTH) {
                        ...
                        if (userEntered.equals(SetPin)) {
                            statusView.setTextColor(Color.GREEN);
                            statusView.setText("Correct");
                            Log.v("PinView", "Correct PIN");


                            String qry = "update EMPLOYEEMJOININGDETAILS set PINNO='" + userEntered + "' WHERE EMPLOYEEID='" + empID + "'";
                            try {
                            ...
                            dbHelper.pin_insert(userEntered);
                            Toast toast = Toast.makeText(getApplicationContext(), "Login PIN has been set successfully.", Toast.LENGTH_SHORT);
                            toast.show();
                            Intent home = new Intent(getApplicationContext(), LoginForm.class);
                            startActivity(home);
                            finish();
