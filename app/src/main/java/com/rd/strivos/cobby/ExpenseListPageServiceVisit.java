 ...
 */
public class ExpenseListPageServiceVisit extends AppCompatActivity {

    ListView lvDetail;
    Context context = ExpenseListPageServiceVisit.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getDataInList();
        lvDetail.setAdapter(new ExpenseListPageServiceVisitBaseAdapter(context, myList));
    }
