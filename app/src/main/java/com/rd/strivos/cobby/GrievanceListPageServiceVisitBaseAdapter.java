 ...
 */
public class GrievanceListPageServiceVisitBaseAdapter extends BaseAdapter{
    ArrayList<ListDataGrievance> myList = new ArrayList<ListDataGrievance>();
    LayoutInflater inflater;
    Context context;
    int[] result;

    public GrievanceListPageServiceVisitBaseAdapter(Context context, ArrayList<ListDataGrievance> myList) {
        this.myList = myList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((GrievanceListPageServiceVisit) context).startAddGrievanceActivity(Long.valueOf(tEXT).longValue());
            }
        });
        ...
        convertView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                TextView text = (TextView) view.findViewById(R.id.txt_frameIdDisplay);
                String tEXT = text.getText().toString();
                ((GrievanceListPageServiceVisit) context).deleteGrievance(Long.valueOf(tEXT).longValue());
                return true;
            }
        });
